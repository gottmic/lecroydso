...
LeCroyDSO implements convenient and Pythonic programming in three layers:
 ...
 1. Low-level: A wrapper around the shared visa library.
    ...
    All level 1 functions are **static methods** of |DSOConnection|.

...
LeCroyDSO: Control your lecroy instruments with Python
======================================================
...
LeCroyDSO is a Python package that enables you to control all kinds of measurement
...
the VISA standard directly in Python (see the `LeCroyDSO-Py` project for more
details). LeCroyDSO is both a Python wrapper for VISA shared libraries but
